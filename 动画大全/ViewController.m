...
- (void)initData {
    _dataArray = [[NSArray alloc] initWithObjects:@"Calayer 绘制图形",@"Calayer绘制图像",@"CoreAnimation",@"CADisplayLink(游动的鱼儿)",@"CATransition(转场动画)",@"UIViewAnimation", nil];
    _classArray = [[NSArray alloc] initWithObjects:@"CalayerBasicViewController",@"CalayerGraphicViewController",@"AnimationViewController",@"DisplayViewController",@"TransitionViewController",@"UIAnimationViewController", nil];
}
